...
<template>
  <section class="profile">
    ...
    <section class="profile_my_order border-1px" v-show="user._id">
      <mt-button size="large" type="danger" @click="logout">退出登陆</mt-button>
    </section>
...
import { RECEIVE_LOGINOUT } from "@/vuex/types";
export default {
  data() {
    return {};
  },
  methods: {
    ...
    logout() {
      //退出登录
    MessageBox.confirm("确认注销吗").then(
      actionAgree => this.$store.commit(RECEIVE_LOGINOUT),
      actionReject => {}
